...
function Results() {
    ...
    let candidateDescription =
        "Default description, in order to get this you must've clicked neutral on literally every question. Congrats I guess.";
    ...
    const calculateMatch = () => {
        ...
        for (let i = 0; i < ideologies.length; i++) {
            compareTotal =
                Math.abs(e - ideologies[i].stats.econ) +
                Math.abs(l - ideologies[i].stats.legal) +
                Math.abs(g - ideologies[i].stats.global) +
                Math.abs(s - ideologies[i].stats.social);
        ...
        <>
            ...
            <div className="closest-container">
                <div className="closest-subcontainer">
                    <h2>
                        <b style={{ color: "#B53F47" }}>Closest Match</b>: {ideology}
                    </h2>
                ...
                <div className="closest-subcontainer">
                    <h2>
                        <b style={{ color: "#B53F47" }}>Closest Political Candidate</b>: {candidate}
                    </h2>
                    ...
                    <div className="surprised-container">
                        <h1 id="title">
                            <b style={{ color: "#B53F47" }}>Poland</b>
                            <b>Values</b>
                        </h1>
                        <img alt="surprised icon of poland" height="200px" src={surprised}></img>
                        <p className="left-rotate-text">
                            Surprised by the results?<br></br>Contribute on our <a href="https://github.com/Datacr4b/modern-pol">github!</a>
                        </p>
                    </div>
                </div>
            </div>
